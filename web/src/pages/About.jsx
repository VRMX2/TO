  ...
  return (
    <div className="dashboard-layout page-transition">
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '940px', width: '100%', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          ...
          <div className="page-transition" style={{
            ...
            <div style={{
              ...
              <div style={{ width: '100%', height: '100%', borderRadius: 21, background: 'rgba(2,6,23,0.95)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
            ...
            <div style={{ zIndex: 1 }}>
              <h1 className="font-mono" style={{ fontSize: '3rem', margin: '0 0 0.5rem', letterSpacing: '0.12em', color: '#f8fafc', textShadow: '0 0 30px rgba(0,240,255,0.4)' }}>
              ...
              <p className="font-mono" style={{ fontSize: '0.85rem', margin: 0, color: 'var(--text-secondary)', letterSpacing: '0.05em' }}>
                {t('app.tagline')}
              </p>
            </div>
          </div>
